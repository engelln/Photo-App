...
<body class="darkbg">
    ...
    <h1 class="display-3 text-center text-light mt-3">Latest Posts</h1>
    <div class="container main-container border-25  bg-dark pt-4">
        <div class="row row-cols-5" id="latestPosts">
            <?php
            include("utils.php");
            $first_page = paginate_latest_posts(0, 20);
    ...
    <script>
        ...
        async function loadMoreImages() {
            var response = await fetch("latestposts.php?page=" + page);
